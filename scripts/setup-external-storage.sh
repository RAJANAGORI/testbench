...
#
# Usage:
#   ./scripts/setup-external-storage.sh /run/media/$USER/<uuid-or-label>
#   ./scripts/setup-external-storage.sh /run/media/$USER/<uuid> --persist-mount
#   ./scripts/setup-external-storage.sh /mnt/scas-data --docker-only
#   ./scripts/setup-external-storage.sh /mnt/scas-data --move-repo
#
...
cat > "$MARKER" <<EOF
# Generated by scripts/setup-external-storage.sh

...
![Scenario 16 observability flow: Phase 1 collectors → Phase 2 lab steps → Phase 3 localhost exfil → optional Elasticsearch → Kibana Detections and Rules](../../assets/diagrams/scas-observability-scenario-16.svg)

*Swimlane diagram for Scenario 16. Editable source: [`scas-observability-scenario-16.excalidraw`](../../assets/diagrams/scas-observability-scenario-16.excalidraw). Regenerate with `node scripts/generate-scenario-observability-diagrams.js`.*
